...
public class MovieListActivity extends BaseActivity
    ...
    private final static int MAX_WIDTH_ONEPANE_COL_DP = 180;
    private final static int MAX_WIDTH_TWOPANE_COL_DP = 80;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ITEM_WIDTH = ((mTwoPane) ? MAX_WIDTH_TWOPANE_COL_DP : MAX_WIDTH_ONEPANE_COL_DP)
